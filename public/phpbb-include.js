var irisTemplate = '<div id="entry-template" style="display: none;">' +
'    <div class="jumbotron" style="padding: 20px;">' +
'        <h1 style="margin-top:0; font-size: 40px;" class="display-3">{{name}}</h1>' +
'        <p class="lead">{{{description}}}</p>' +
'        <p><a target="_blank" class="btn btn-primary" href="https://iris.501st.nl/event/{{_id}}" role="button">View event in IRIS <i class="fa fa-external-link" aria-hidden="true"></i></a></p>' +
'    </div>' +
